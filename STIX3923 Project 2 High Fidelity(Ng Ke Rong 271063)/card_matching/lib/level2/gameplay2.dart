...
import 'package:card_matching/level3/gameplay3.dart';


class GamePlay2Page extends StatefulWidget {
  const GamePlay2Page({Key? key}) : super(key: key);

  @override
 GamePlay2PageState createState() => GamePlay2PageState();

}


class GamePlay2PageState extends State<GamePlay2Page> {
  //setting text style
  bool hideTest = false;
  final Game2 _game = Game2();
  String getColor = '';
  String selectCol = " ";
  String latestCol = " ";
...
Color otherColor2 = Color(0x00000000);
  ...
  void loadScore() async {
    ...
    setState((){
      highestScore = (prefs.getDouble('highScore2') ?? 0);
    });
  }
  ...
  void updateScore() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      prefs.setDouble('highScore2', latestScore);
      highestScore = (prefs.getDouble('highScore2') ?? 0);
    });
  }
