...
class GamePlay1Page extends StatefulWidget {
  const GamePlay1Page({Key? key}) : super(key: key);

  @override
 GamePlay1PageState createState() => GamePlay1PageState();

}


class GamePlay1PageState extends State<GamePlay1Page> {
  //setting text style
  bool hideTest = false;
  final Game1 _game = Game1();
  String getColor = '';
  String selectCol = " ";
  String latestCol = " ";
Color color1 = Color(0xFFFFECB3);
  ...
  void updateScore() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    setState(() {
      prefs.setDouble('highScore', latestScore);
      highestScore = (prefs.getDouble('highScore') ?? 0);
    });
  }
